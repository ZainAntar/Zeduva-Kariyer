...
- Öğrencilerin ilgi alanlarını daha iyi analiz edebilmelerini sağlamak
...
- Performans odaklı iyileştirmeler
- React + TypeScript + Vite temelli hızlı geliştirme
- Örnek ESLint/tsconfig yapılandırmaları

## ⚙️ Sistem Akışı

1. Kullanıcı kariyer yönelim sorularını yanıtlar
2. Sistem cevapları analiz eder
3. Uygun kariyer alanları önerilir
4. Önerilen alanlara dair açıklama ve yönlendirmeler sunulur
...
Üretim için derleyip önizleyin:
